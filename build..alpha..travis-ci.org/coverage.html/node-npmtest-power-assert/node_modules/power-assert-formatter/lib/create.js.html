...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-power-assert/node_modules/power-assert-formatter/lib/create.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-power-assert/node_modules/power-assert-formatter/lib/create.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-power-assert/node_modules/power-assert-formatter/lib/</a> &#187; create.js</div>
</div>
<div class="body">
...
function toRendererClass (rendererName) {
    var RendererClass;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof rendererName === 'function') {
<span class="cstat-no" title="statement not covered" >        RendererClass = rendererName;</span>
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof rendererName === 'string') {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (defaultRendererClasses[rendererName]) {
            RendererClass = defaultRendererClasses[rendererName];
        } else {
<span class="cstat-no" title="statement not covered" >            RendererClass = require(rendererName);</span>
        }
    }
